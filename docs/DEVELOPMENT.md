...
The validated target toolchain is ESP-IDF v6.0.1 for ESP32-C6. Host tests declare CMake 3.16 or later and C11; they require a compatible compiler, threading support, and sanitizer runtimes for sanitizer configurations. Python 3 is used by engineering tools.
