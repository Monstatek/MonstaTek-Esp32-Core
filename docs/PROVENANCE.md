...
This file records validation scope only. Build dependencies are documented in
...
Hardware-only validation gaps include worst-case runtime heap and task-stack
