 ...
 * (schemas.json adapter_map.compat_c3, 002-adapter-translation-matrix.md). */
#pragma once
#include <stdint.h>
 ...
 * discovery phase") as a valid Mtek Compatibility/C3 `m1_link` frame, per the wire
 ...
 * and recognized if `buf`/`len` contain one complete, CRC-valid Mtek Compatibility
