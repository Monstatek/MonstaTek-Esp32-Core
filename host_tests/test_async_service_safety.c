 ...
 * test_session_publication.c's own established
 ...
 * test_session_publication.c's own (mtk_op_set_won_hook
 ...
 * test_session_publication.c's own. ---- */
 ...
 * mutex), exactly like test_peer_reset_concurrency.c's and test_
 ...
 * all -- the same proof test_session_publication.c's
