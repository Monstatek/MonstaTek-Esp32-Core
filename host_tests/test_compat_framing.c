/* Legacy SPI Compatibility `m1_link` framing (001-profile-bootstrap-feasibility.md Sec 1):
...
MTK_TEST_MAIN_BEGIN
    ...
    /* Cross-profile rejection: native's fixed magic never parses as Legacy SPI Compatibility. */
    ...
    /* ---- End-to-end dispatch: DEAUTH_START via real Legacy SPI Compatibility wire bytes ---- */
