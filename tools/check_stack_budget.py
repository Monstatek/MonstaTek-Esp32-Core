...
CHAINS = [
    {'task': 'mtek_async_op (Deauth TX)',
     'stack_bytes': 4096,
     'margin': 0.6,
     'members': [('main/app_main.c', 'async_task_trampoline'),
                 ('components/mtek_router/mtek_router.c', 'async_trampoline'),
                 ('components/mtek_wifi_service/mtek_wifi_logic.c', 'mtek_wifi_dispatch'),
                 ('components/mtek_wifi_service/mtek_wifi_logic.c', 'handle_deauth_start'),
                 ('components/mtek_wifi_service/mtek_wifi_hal_esp32.c', 'esp32_send_deauth'),
                 ('components/mtek_wifi_service/mtek_wifi_hal_esp32.c', 'capture_prior_state_once')]},
    {'task': 'mtek_async_op (Deauth progress event)',
     'stack_bytes': 4096,
     'margin': 0.6,
     'members': [('main/app_main.c', 'async_task_trampoline'),
                 ('components/mtek_router/mtek_router.c', 'async_trampoline'),
    ...
    {'task': 'wifi_promisc_tick_task (Handshake TX)', 'stack_bytes': 4096, 'margin': 0.6, 'members': [('main/app_main.c', 'wifi_promisc_tick_task'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'mtek_wifi_service_tick'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'handshake_tx_tick'), ('components/mtek_wifi_service/mtek_wifi_hal_esp32.c', 'esp32_send_deauth'), ('components/mtek_wifi_service/mtek_wifi_hal_esp32.c', 'capture_prior_state_once')]},
    {'task': 'wifi_promisc_tick_task (Beacon failure event)', 'requires_sdkconfig': 'CONFIG_MTEK_MODULE_BEACON_VARIANTS', 'stack_bytes': 4096, 'margin': 0.6, 'members': [('main/app_main.c', 'wifi_promisc_tick_task'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'mtek_wifi_service_tick'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'beacon_tick'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'beacon_finish'), ('components/mtek_core/mtek_async_queue.c', 'mtk_async_sink_event')]},
    {'task': 'wifi_promisc_tick_task (Handshake failure event)', 'stack_bytes': 4096, 'margin': 0.6, 'members': [('main/app_main.c', 'wifi_promisc_tick_task'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'mtek_wifi_service_tick'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'handshake_tx_tick'), ('components/mtek_wifi_service/mtek_wifi_logic.c', 'handshake_finish'), ('components/mtek_core/mtek_async_queue.c', 'mtk_async_sink_event')]},
    {
        "task": "wifi_promisc_tick_task (Beacon TX)",
        "requires_sdkconfig": "CONFIG_MTEK_MODULE_BEACON_VARIANTS",
        "stack_bytes": 4096,
        "margin": 0.60,
        "members": [
            ("main/app_main.c", "wifi_promisc_tick_task"),
            ("components/mtek_wifi_service/mtek_wifi_logic.c", "mtek_wifi_service_tick"),
            ("components/mtek_wifi_service/mtek_wifi_logic.c", "beacon_tick"),
            ("components/mtek_wifi_service/mtek_wifi_hal_esp32.c", "esp32_set_channel"),
            ("components/mtek_wifi_service/mtek_wifi_hal_esp32.c", "capture_prior_state_once"),
        ],
    },
    {
    ...
    {
        "task": "spi_runtime_task (Legacy SPI Compatibility worst path)",
        "stack_bytes": 12288,
        "margin": 0.60,
        "members": [
            ("main/mtek_spi_runtime.c", "spi_runtime_task"),
    ...
    {
        # Factory-UART MonstaShark compatibility runs synchronously in the
        # UART task. Include its largest local record/poll path explicitly;
        # the large protocol buffers themselves are static state, not stack.
        "task": "uart_repl_task (MonstaShark PCAP streaming path)",
        "stack_bytes": 12288,
        "margin": 0.60,
        "members": [
            ("main/app_main.c", "uart_repl_task"),
            ("components/mtek_transport_uart/mtek_uart_pcap.c", "mtek_uart_pcap_run"),
            ("components/mtek_transport_uart/mtek_uart_pcap.c", "poll_record"),
            ("components/mtek_router/mtek_router.c", "mtk_router_dispatch"),
            ("components/mtek_capture_service/mtek_capture_logic.c", "mtek_capture_dispatch"),
        ],
    },
